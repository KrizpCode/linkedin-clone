...
const Header = () => {
    ...
    // Return a spinner instead when this is mounting
    if (!mounted) return null;

    return (
        <header className="sticky top-0 z-40 bg-white dark:bg-[#1D2226] flex ic justify-around py-1.5 px-3 focus-within:shadow-lg">
            ...
            <div className="flex items-center space-x-6">
                ...
                <HeaderLink Avatar={Avatar} text="Me" feed avatar hidden />
